...
odoo.define('pos_retail.screen_product_list', function (require) {
    ...
    screens.ProductScreenWidget.include({
        ...
        refresh_screen: function () {
            var self = this;
            this.pos.get_modifiers_backend_all_models().then(function (results) {
        ...
        rerender_products_screen: function (product_view) { // function work without mobile app
            console.log('Starting rerender_products_screen()');
            if (this.pos.pos_session.mobile_responsive) {
                return;
            }
            var self = this;
        ...
        show: function () {
            ...
            if (!this.pos.pos_session.mobile_responsive) {
                if (this.pos.show_left_buttons == true) {
                    ...
                    $('.rightpane').animate({left: 610}, 'fast');
