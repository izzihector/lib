        ...
        click_confirm: function () {
            ...
            if (move_lines.length > 0) {
                ...
                this.pos.gui.show_popup('confirm', {
                    title: 'Warning',
                    body: 'Your Order have not product have type is Storable Product, or all quantities of lines smaller than 0'
                })
            }
        }
    });
    ...
    var popup_account_invoice_refund = PopupWidget.extend({
        ...
        show: function (options) {
            ...
            $('.timepicker').datetimepicker({
                ...
                format: 'HH:mm:00', //use this format if you want the 12hours timpiecker with AM/PM toggle
                icons: {
                    time: "fa fa-clock-o",
                    date: "fa fa-calendar",
                    up: "fa fa-chevron-up",
