        ...
        import_pending_order: function (str) {
            ...
            if (json.length <= 0) {
                return this.gui.show_popup('dialog', {
                    title: 'Warning',
                    body: _t('Your file attachment have not any orders, please checking file name for correct file need import')
                })
            } else {
            ...
            if (exist_orders) {
                this.gui.show_popup('dialog', {
                    title: 'Warning',
                    body: _t('Have total exist orders : ' + exist_orders)
                })
            }
            return report;
        }
