"use strict";
odoo.define('pos_retail.popup_selection_multi_quantity', function (require) {
    ...
    var popup_selection_multi_quantity = PopupWidget.extend({ // select combo
        template: 'popup_selection_multi_quantity',
    ...
    gui.define_popup({name: 'popup_selection_multi_quantity', widget: popup_selection_multi_quantity});
});
