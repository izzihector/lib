...
class ReportPosOrder(models.Model):
    ...
    def _select(self):
        return super(ReportPosOrder, self)._select() + ", SUM(l.margin) AS margin, l.pos_branch_id as pos_branch_id, l.user_id as seller_id, l.analytic_account_id as analytic_account_id"
